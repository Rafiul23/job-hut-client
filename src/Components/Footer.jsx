...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#054efa] text-white">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#054efa] text-white border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Job Hut <br />Providing reliable tech since 1992</p>
                </aside>
